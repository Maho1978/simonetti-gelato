...
"[project]/OneDrive/Desktop/simonetti-hybrid/lib/supabase.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/OneDrive/Desktop/simonetti-hybrid/pages/_app.tsx [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function App({ Component, pageProps }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$simonetti$2d$hybrid$2f$lib$2f$supabase$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.getSession().then(({ data: { session } })=>{
            setSession(session);
        });
        const { data: { subscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$simonetti$2d$hybrid$2f$lib$2f$supabase$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange((_event, session)=>{
            setSession(session);
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e1211ccd._.js.map