...
"[project]/OneDrive/Desktop/simonetti-hybrid/pages/api/settings.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    if (req.method === 'GET') {
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$simonetti$2d$hybrid$2f$lib$2f$supabase$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabase"].from('shop_settings').select('*').eq('id', 'main').single();
        ...
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$simonetti$2d$hybrid$2f$lib$2f$supabase$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabase"].from('shop_settings').update({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a668d7dc._.js.map