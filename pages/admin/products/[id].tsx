...
interface Product {
  id: string; name: string; description: string; price: number; icon: string; category_id: string; available: boolean; scoop_count: number
}
interface Category {
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm mb-8">
          ...
          <form onSubmit={saveProduct} className="grid md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-3 pt-6">
              <input type="checkbox" id="available" checked={editAvailable} onChange={e => setEditAvailable(e.target.checked)}
                className="w-5 h-5 rounded" />
              <label htmlFor="available" className="font-semibold text-gray-700">Produkt aktiv / sichtbar</label>
            </div>
            <div className="md:col-span-2">
              <button type="submit" className="flex items-center gap-2 px-8 py-3 rounded-xl font-bold text-white transition-all hover:opacity-90"
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <div className="space-y-2">
              ...
              {extras.length === 0 && (
                <div className="text-center py-8 text-gray-400">Keine Extras</div>
              )}
            </div>
          </div>
        </div>
