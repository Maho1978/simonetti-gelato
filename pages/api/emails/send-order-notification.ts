...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:580px;">
  <tr>
    <td style="background-color:#2d2d2d;border-radius:16px 16px 0 0;padding:28px 40px;text-align:center;">
      <img src="${LOGO_URL}" alt="Eiscafé Simonetti" width="100" height="100"
        style="border-radius:50%;object-fit:cover;border:3px solid #fff;display:block;margin:0 auto 12px;" />
      <div style="color:#ffffff;font-size:20px;font-weight:900;letter-spacing:3px;text-transform:uppercase;">Eiscafé Simonetti</div>
      <div style="color:#888888;font-size:11px;letter-spacing:4px;margin-top:4px;">G E L A T E R I A · L A N G E N F E L D</div>
    </td>
  </tr>
  <tr>
